...
export const Login = () => {
  ...
  async function handleLoginGuest(){
    email.current.value = "Apeksha@example.com";
    password.current.value ="apeksha";
    try{
      const authDetail = {
        email: email.current.value,
        password: password.current.value
